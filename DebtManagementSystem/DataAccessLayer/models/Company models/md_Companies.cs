...
namespace DataAccessLayer.models
{
    public class md_Companies
    {
        ...
        public md_Companies(int companyId, string managerFullName, string companyName, string companyCode, byte[]? companyImage,
            string phone1, string? phone2, string address, double subscriptionFee, string currency, DateTime registrationDate,
            string subscriptionStatus, DateTime subscriptionStartDate, DateTime subscriptionEndDate, int remainingSubscriptionDays, string? description,
            string isPaid, int byAdmin, string action)
        {
            CompanyId = companyId;
